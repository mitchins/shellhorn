...
class ShellhornMonitor:
    ...
    def load_secrets(self) -> Dict[str, Any]:
        ...
        secrets_file = self.config.get('secrets_file', '/etc/shellhorn-monitor/secrets.json')
        if secrets_file and os.path.exists(secrets_file):
            ...
            logger.debug(f"Secrets file {secrets_file} not found, using environment variables only")
...
def load_config() -> Dict[str, Any]:
    ...
    config_file = os.getenv('SHELLHORN_MONITOR_CONFIG', '/etc/shellhorn-monitor/config.json')
    ...
    default_config = {
        ...
        'secrets_file': os.getenv('SHELLHORN_SECRETS_FILE', '/etc/shellhorn-monitor/secrets.json')
    }
