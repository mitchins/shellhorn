...
class CommandRunner:
    ...
    def __init__(self, command: List[str], notifiers: Optional[List] = None, preferences: Optional[Dict[str, bool]] = None):
    ...
    def _notify_start(self, command: str):
        ...
        for notifier in self.notifiers:
            ...
            if hasattr(notifier, '_is_status_publisher') or type(notifier).__name__ == 'MQTTNotifier':
